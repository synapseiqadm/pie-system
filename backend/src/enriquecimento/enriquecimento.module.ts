...
import { OutboundEnriquecimento } from './entities/outbound-enriquecimento.entity';
...
@Module({
  imports: [
    TypeOrmModule.forFeature([SiteEnriquecimento, AddressEnriquecimento, ContactEnriquecimento, SocioEnriquecimento, OutboundEnriquecimento, EnrichmentData]),
    RecortesModule,
    BasePrimariaModule,
    AiModule,
  ],
