...
@Controller('qualificacoes')
export class QualificacoesController {
  constructor(
    private readonly service: QualificacoesService,
  ...
  async upload(@UploadedFile() file: Express.Multer.File) {
    ...
    await this.statsService.logImport('qualificacoes', result.inserted, result.errors);
    return result;
  }
}
